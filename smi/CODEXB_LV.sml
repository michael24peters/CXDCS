...
object: CODEXB_LV is_of_class TOP_DCS_Domain_v1_CLASS
...
object: CODEXB_LV_FWCNM is_of_class FwChildrenMode_CLASS
...
object: CODEXB_LV_FWM is_of_class FwMode_CLASS



object: CAEN:cxcaen01:board10:channel000 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board10:channel001 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board10:channel002 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board10:channel003 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board10:channel004 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board10:channel005 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board10:channel006 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board10:channel007 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board11:channel000 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board11:channel001 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board11:channel002 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board11:channel003 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board11:channel004 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board11:channel005 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board11:channel006 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board11:channel007 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board12:channel000 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board12:channel001 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board12:channel002 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board12:channel003 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board12:channel004 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board12:channel005 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board12:channel006 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board12:channel007 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board13:channel000 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board13:channel001 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board13:channel002 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board13:channel003 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board13:channel004 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board13:channel005 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board13:channel006 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board13:channel007 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board14:channel000 is_of_class FwCaenChannelA2551_CLASS

object: CAEN:cxcaen01:board14:channel001 is_of_class FwCaenChannelA2551_CLASS
...
objectset: FWCAENCHANNELA2551_FWSETSTATES is_of_class VOID {CAEN:cxcaen01:board10:channel000,
	CAEN:cxcaen01:board10:channel001,
	CAEN:cxcaen01:board10:channel002,
	CAEN:cxcaen01:board10:channel003,
	CAEN:cxcaen01:board10:channel004,
	CAEN:cxcaen01:board10:channel005,
	CAEN:cxcaen01:board10:channel006,
	CAEN:cxcaen01:board10:channel007,
	CAEN:cxcaen01:board11:channel000,
	CAEN:cxcaen01:board11:channel001,
	CAEN:cxcaen01:board11:channel002,
	CAEN:cxcaen01:board11:channel003,
	CAEN:cxcaen01:board11:channel004,
	CAEN:cxcaen01:board11:channel005,
	CAEN:cxcaen01:board11:channel006,
	CAEN:cxcaen01:board11:channel007,
	CAEN:cxcaen01:board12:channel000,
	CAEN:cxcaen01:board12:channel001,
	CAEN:cxcaen01:board12:channel002,
	CAEN:cxcaen01:board12:channel003,
	CAEN:cxcaen01:board12:channel004,
	CAEN:cxcaen01:board12:channel005,
	CAEN:cxcaen01:board12:channel006,
	CAEN:cxcaen01:board12:channel007,
	CAEN:cxcaen01:board13:channel000,
	CAEN:cxcaen01:board13:channel001,
	CAEN:cxcaen01:board13:channel002,
	CAEN:cxcaen01:board13:channel003,
	CAEN:cxcaen01:board13:channel004,
	CAEN:cxcaen01:board13:channel005,
	CAEN:cxcaen01:board13:channel006,
	CAEN:cxcaen01:board13:channel007,
	CAEN:cxcaen01:board14:channel000,
	CAEN:cxcaen01:board14:channel001,
	CAEN:cxcaen01:board14:channel002,
...
objectset: FWCAENCHANNELA2551_FWSETACTIONS is_of_class VOID {CAEN:cxcaen01:board10:channel000,
	CAEN:cxcaen01:board10:channel001,
	CAEN:cxcaen01:board10:channel002,
	CAEN:cxcaen01:board10:channel003,
	CAEN:cxcaen01:board10:channel004,
...
object: CODEXB_LV_FWDM is_of_class FwDevMode_CLASS

objectset: FWDEVMODE_FWSETSTATES is_of_class VOID {CODEXB_LV_FWDM }
objectset: FWDEVMODE_FWSETACTIONS is_of_class VOID {CODEXB_LV_FWDM }
